...
const swiper1 = new Swiper('.swiper', {
  ...
  const swiper2 = new Swiper('.swiper2', {
    ...
    navigation: {
        ...
        slideNext: ".dreamteam__slider-arrow-right",
        slidePrev: ".dreamteam__slider-arrow-left",
      },
});
...
$('.menu__phone-button').on('click', function () {
  ...
  $('.collection__items-wrapper').css({'z-index':'-1'});
  $('.dreamteam__wrapper').css({'z-index':'-1'});
  $('.swiper').css({'z-index':'-1'});
  
})
$('.modal-window__close-btn').on('click', function () {
  $('.wrapper-modal').removeClass('wrapper-modal_active');
  $('.collection__items-wrapper').css({'z-index':'0'});
  $('.dreamteam__wrapper').css({'z-index':'0'});
